...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
	...
	protected <T> T doGetBean(
		...
		if (sharedInstance != null && args == null) {
			...
			// A 中有B 的属性， B中有A的属性，那么当依赖注入的时候，就会产生当A还未创建完的时候
			...
			// 如果beanDefinitionMap中也就是已加载的类中不包括beanName则尝试从parentBeanFactory检测
			...
			try {
				...
				// 将存储xml配置文件的GernericBeanDefinition转换为RootBeanDefinition,如果beanName是子bean的话同时会合并父类的相关属性
